...
| Метрика | Python (8M) | Комментарий |
|---------|-------------|-------------|
| JSON size | 1.65 GB | Линейно: ~222 B/row |
| Avro size | 313 MB | Линейно: ~41 B/row |
| Parquet size | 238 MB | Линейно: ~31 B/row |
| Avro full-scan | 58.6s (137k r/s) | Go быстрее в ~9× (нативный код vs Python) |
| Parquet full-scan | 2.2s (3.6M r/s) | Python быстрее — column pruning + PyArrow C++ |
